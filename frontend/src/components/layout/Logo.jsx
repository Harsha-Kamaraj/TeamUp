...
export default function Logo({ className }) {
  return (
    <Link to="/" className={cn('group inline-flex items-center gap-2', className)}>
      <span
        aria-hidden
        className="bg-brand-gradient grid h-8 w-8 place-items-center rounded-xl text-white shadow-sm transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110"
      >
