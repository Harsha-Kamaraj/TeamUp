  ...
  return (
    <div className="w-full">
      ...
      <select
        ...
        aria-invalid={!!error}
        className={cn(
          'w-full appearance-none rounded-lg border bg-white bg-[length:16px] bg-[right_0.75rem_center] bg-no-repeat px-3.5 py-2 pr-10 text-sm text-slate-900 transition',
